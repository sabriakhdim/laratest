...
<li class="nav-item">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url({{ asset('images/homePage/IMG_9345.jpg') }});">
            </div>
            <div class="carousel-item" style="background-image: url({{ asset('images/homePage/IMG_3887.JPG') }});">
            </div>
            <div class="carousel-item" style="background-image: url({{ asset('images/homePage/IMG_4573.JPG') }});">
            </div>
        </div>
